...
@section('main-content')
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-black-800">{{ $widget['member'] }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        <div class="col-md-3 col-12">
            <a href="{{ url('/home/generate-data') }}" class="btn btn-primary mb-2" style="background-color: #; color: white;">Cetak Data</a>
        </div>
        <div class="col-12">
            <table class="table table-bordered table-stripped">
                <thead>
                    <tr style="background-color: #d38714; color: white;">
                        <th>No</th>
                        <th>Kode Invoice</th>
                        <th>Pelanggan</th>
                        <th>Outlet</th>
